...
This will:
1. Configure git for proper merge handling
2. Configure upstream remote
3. Mark publishing workflows as disabled
...
- [FORK_SETUP_GUIDE.md](FORK_SETUP_GUIDE.md) - Detailed setup and configuration guide
- [TROUBLESHOOTING.md](TROUBLESHOOTING.md) - Troubleshooting and FAQ

...
fn install_git_private_https_pat_not_authorized() {
    ...
    // A revoked token (modified for fork to avoid security scanning issues)
    let token = "github_pat_XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
